(async() => {
    ...
    async function GetAllSemesterPeriods(){
        try{
            const response = await fetch ('httpss://localhost:51934/api/Calendar/Periods',{
                method: "GET",
                credentials:"include",
                header:{
    ...
    async function GetAllDays(){
        try{
            const response = await fetch ('httpss://localhost:51934/api/days/all',{
                method: "GET",
                credentials:"include",
                header:{
                    "Context-Type":"application/json"
    ...
    {
        try{
            const response = await fetch ('httpss://localhost:51934/api/User/' + RoleId,{
                method: "GET",
                credentials:"include",
                header:{
                    "Context-Type":"application/json"
    ...
    {
        try{
            const response = await fetch ('httpss://localhost:51934/api/SemesterPeriod/' + semesterPeriodId,{
                method: "GET",
                credentials:"include",
                header:{
                    "Context-Type":"application/json"
    ...
    async function AssignToCourse(teacherId, courseID){
        ...
        try{
                ...
                const response = await fetch('httpss://localhost:51934/api/Coursesection/Assign', {
                method: "POST",
                credentials: "include",
                headers: {
...
if (response.ok) {
    ...
    async function GetAllClassDurations(){
        try{
            const response = await fetch ('httpss://localhost:51934/api/ClassDuration/Times',{
                method: "GET",
                credentials:"include",
                header:{
                    "Context-Type":"application/json"
    ...
    async function GetAllBuildings(){
        try{
            ...
            const response = await fetch ('httpss://localhost:51934/api/Buildings/All',{
                method: "GET",
                credentials:"include",
                header:{
                    "Context-Type":"application/json"
    ...
    async function GetAllRoomsByBuildingId(buildingId){
        ...
        try{
            const response = await fetch ('httpss://localhost:51934/api/Buildings/' + buildingId + '/Rooms',{
                method: "GET",
                credentials:"include",
                header:{
                    "Context-Type":"application/json"
